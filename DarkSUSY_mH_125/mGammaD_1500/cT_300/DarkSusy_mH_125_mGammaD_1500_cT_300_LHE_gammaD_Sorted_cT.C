...
//=========  (Mon Mar 16 14:13:27 2015) by ROOT version5.34/18
   ...
   cnv->Range(-3.1875,-0.0621934,15.5625,0.4162174);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.3827287);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.2125345);
   h_gammaD_1_cT->SetBinContent(2,0.07729632);
   h_gammaD_1_cT->SetBinContent(3,0.02883252);
   h_gammaD_1_cT->SetBinContent(4,0.01071102);
   h_gammaD_1_cT->SetBinContent(5,0.003958968);
   h_gammaD_1_cT->SetBinContent(6,0.002168206);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.212627);
   h_gammaD_2_cT->SetBinContent(2,0.07709996);
   h_gammaD_2_cT->SetBinContent(3,0.02925972);
   h_gammaD_2_cT->SetBinContent(4,0.01041903);
   h_gammaD_2_cT->SetBinContent(5,0.003927591);
