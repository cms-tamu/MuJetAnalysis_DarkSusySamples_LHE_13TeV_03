...
//=========  (Mon Mar 16 13:48:52 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.053125,-3.720091,0.259375,24.89599);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(22.89287);
   ...
   h_gammaD_1_cT->SetBinContent(1,12.74895);
   h_gammaD_1_cT->SetBinContent(2,4.670796);
   h_gammaD_1_cT->SetBinContent(3,1.70884);
   h_gammaD_1_cT->SetBinContent(4,0.6337337);
   h_gammaD_1_cT->SetBinContent(5,0.2376816);
   h_gammaD_1_cT->SetBinContent(6,0.1422565);
   ...
   h_gammaD_2_cT->SetBinContent(1,12.71826);
   h_gammaD_2_cT->SetBinContent(2,4.691436);
   h_gammaD_2_cT->SetBinContent(3,1.73098);
   h_gammaD_2_cT->SetBinContent(4,0.6207773);
   h_gammaD_2_cT->SetBinContent(5,0.2385476);
   h_gammaD_2_cT->SetBinContent(6,0.1303456);
