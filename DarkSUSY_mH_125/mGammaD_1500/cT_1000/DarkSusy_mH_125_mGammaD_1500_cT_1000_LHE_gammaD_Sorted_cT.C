...
//=========  (Wed Mar 18 13:56:35 2015) by ROOT version5.34/18
   ...
   cnv->Range(-10.625,-0.0186478,51.875,0.1247968);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.1147557);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.06384338);
   h_gammaD_1_cT->SetBinContent(2,0.02327823);
   h_gammaD_1_cT->SetBinContent(3,0.008598173);
   h_gammaD_1_cT->SetBinContent(4,0.003149141);
   h_gammaD_1_cT->SetBinContent(5,0.001131074);
   h_gammaD_1_cT->SetBinContent(6,0.0006504618);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.06375315);
   h_gammaD_2_cT->SetBinContent(2,0.02311209);
   h_gammaD_2_cT->SetBinContent(3,0.008732998);
   h_gammaD_2_cT->SetBinContent(4,0.003231738);
   h_gammaD_2_cT->SetBinContent(5,0.001170025);
   h_gammaD_2_cT->SetBinContent(6,0.0007544081);
