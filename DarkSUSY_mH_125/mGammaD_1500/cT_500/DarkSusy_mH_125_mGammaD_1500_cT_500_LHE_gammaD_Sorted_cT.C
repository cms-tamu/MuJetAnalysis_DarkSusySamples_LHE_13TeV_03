...
//=========  (Mon Mar 16 14:17:18 2015) by ROOT version5.34/18
   ...
   cnv->Range(-5.3125,-0.03723952,25.9375,0.2492183);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2291663);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.127595);
   h_gammaD_1_cT->SetBinContent(2,0.04656227);
   h_gammaD_1_cT->SetBinContent(3,0.01725284);
   h_gammaD_1_cT->SetBinContent(4,0.006268724);
   h_gammaD_1_cT->SetBinContent(5,0.00232119);
   h_gammaD_1_cT->SetBinContent(6,0.001402281);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1273146);
   h_gammaD_2_cT->SetBinContent(2,0.04669595);
   h_gammaD_2_cT->SetBinContent(3,0.01741188);
   h_gammaD_2_cT->SetBinContent(4,0.006372777);
   h_gammaD_2_cT->SetBinContent(5,0.0022048);
   h_gammaD_2_cT->SetBinContent(6,0.001349056);
