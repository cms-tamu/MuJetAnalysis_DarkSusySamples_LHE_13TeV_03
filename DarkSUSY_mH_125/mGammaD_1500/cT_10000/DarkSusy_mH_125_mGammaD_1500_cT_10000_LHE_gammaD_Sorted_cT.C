...
//=========  (Wed Mar 18 13:56:49 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-106.25,-0.001853949,518.75,0.0124072);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.01140892);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.006358078);
   h_gammaD_1_cT->SetBinContent(2,0.00234429);
   h_gammaD_1_cT->SetBinContent(3,0.0008621102);
   h_gammaD_1_cT->SetBinContent(4,0.00031513);
   h_gammaD_1_cT->SetBinContent(5,0.000120391);
   h_gammaD_1_cT->SetBinContent(6,6.390661e-05);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.006338289);
   h_gammaD_2_cT->SetBinContent(2,0.002359739);
   h_gammaD_2_cT->SetBinContent(3,0.0008673103);
   h_gammaD_2_cT->SetBinContent(4,0.00031986);
   h_gammaD_2_cT->SetBinContent(5,0.0001148022);
   h_gammaD_2_cT->SetBinContent(6,7.024081e-05);
