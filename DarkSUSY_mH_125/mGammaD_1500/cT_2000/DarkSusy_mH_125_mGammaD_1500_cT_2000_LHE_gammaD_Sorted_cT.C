...
//=========  (Wed Mar 18 13:56:53 2015) by ROOT version5.34/18
   ...
   cnv->Range(-21.25,-0.009290395,103.75,0.06217418);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.05717166);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.03179181);
   h_gammaD_1_cT->SetBinContent(2,0.01183083);
   h_gammaD_1_cT->SetBinContent(3,0.004245705);
   h_gammaD_1_cT->SetBinContent(4,0.001568381);
   h_gammaD_1_cT->SetBinContent(5,0.0005632828);
   h_gammaD_1_cT->SetBinContent(6,0.0003486689);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.03176203);
   h_gammaD_2_cT->SetBinContent(2,0.0117838);
   h_gammaD_2_cT->SetBinContent(3,0.004309488);
   h_gammaD_2_cT->SetBinContent(4,0.001569831);
   h_gammaD_2_cT->SetBinContent(5,0.00057485);
   h_gammaD_2_cT->SetBinContent(6,0.0003144694);
