...
//=========  (Mon Mar 16 14:08:55 2015) by ROOT version5.34/18
   ...
   cnv->Range(-2.125,-0.09285924,10.375,0.6214426);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.5714415);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.3175864);
   h_gammaD_1_cT->SetBinContent(2,0.1168565);
   h_gammaD_1_cT->SetBinContent(3,0.04393129);
   h_gammaD_1_cT->SetBinContent(4,0.01564211);
   h_gammaD_1_cT->SetBinContent(5,0.005983767);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.3174675);
   h_gammaD_2_cT->SetBinContent(2,0.1173455);
   h_gammaD_2_cT->SetBinContent(3,0.04331333);
   h_gammaD_2_cT->SetBinContent(4,0.01622441);
   h_gammaD_2_cT->SetBinContent(5,0.005649291);
   h_gammaD_2_cT->SetBinContent(6,0.003271304);
