...
//=========  (Mon Mar 16 14:05:04 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-1.0625,-0.1864315,5.1875,1.247657);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(1.147271);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.6357672);
   h_gammaD_1_cT->SetBinContent(2,0.2343215);
   h_gammaD_1_cT->SetBinContent(3,0.08705672);
   h_gammaD_1_cT->SetBinContent(4,0.03092887);
   h_gammaD_1_cT->SetBinContent(5,0.01192575);
   h_gammaD_1_cT->SetBinContent(6,0.007442575);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.6373727);
   h_gammaD_2_cT->SetBinContent(2,0.2327993);
   h_gammaD_2_cT->SetBinContent(3,0.0853522);
   h_gammaD_2_cT->SetBinContent(4,0.03187808);
   h_gammaD_2_cT->SetBinContent(5,0.01259769);
   h_gammaD_2_cT->SetBinContent(6,0.006795958);
