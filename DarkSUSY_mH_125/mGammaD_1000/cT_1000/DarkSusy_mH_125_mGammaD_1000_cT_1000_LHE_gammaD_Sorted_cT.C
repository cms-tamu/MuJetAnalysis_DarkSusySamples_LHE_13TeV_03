...
//=========  (Wed Mar 18 13:54:32 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-10.625,-0.01858104,51.875,0.1243501);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.1143449);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.06393498);
   h_gammaD_1_cT->SetBinContent(2,0.0232191);
   h_gammaD_1_cT->SetBinContent(3,0.008469519);
   h_gammaD_1_cT->SetBinContent(4,0.003216831);
   h_gammaD_1_cT->SetBinContent(5,0.00115957);
   h_gammaD_1_cT->SetBinContent(6,0.0007214262);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.06352494);
   h_gammaD_2_cT->SetBinContent(2,0.02345724);
   h_gammaD_2_cT->SetBinContent(3,0.008618563);
   h_gammaD_2_cT->SetBinContent(4,0.003227714);
   h_gammaD_2_cT->SetBinContent(5,0.001171541);
   h_gammaD_2_cT->SetBinContent(6,0.0006681935);
