...
//=========  (Mon Mar 16 13:24:42 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.53125,-0.3724822,2.59375,2.492765);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(2.292198);
   ...
   h_gammaD_1_cT->SetBinContent(1,1.276703);
   h_gammaD_1_cT->SetBinContent(2,0.468525);
   h_gammaD_1_cT->SetBinContent(3,0.1677998);
   h_gammaD_1_cT->SetBinContent(4,0.06360477);
   h_gammaD_1_cT->SetBinContent(5,0.02336708);
   h_gammaD_1_cT->SetBinContent(6,0.0143778);
   ...
   h_gammaD_2_cT->SetBinContent(1,1.273443);
   h_gammaD_2_cT->SetBinContent(2,0.4699606);
   h_gammaD_2_cT->SetBinContent(3,0.1685477);
   h_gammaD_2_cT->SetBinContent(4,0.06431887);
   h_gammaD_2_cT->SetBinContent(5,0.02372954);
   h_gammaD_2_cT->SetBinContent(6,0.01308522);
