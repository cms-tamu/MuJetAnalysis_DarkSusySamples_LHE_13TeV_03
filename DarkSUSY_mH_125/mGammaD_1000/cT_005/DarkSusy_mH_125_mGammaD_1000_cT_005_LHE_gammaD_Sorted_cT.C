...
//=========  (Mon Mar 16 13:12:56 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.053125,-3.732763,0.259375,24.9808);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(22.97085);
   ...
   h_gammaD_1_cT->SetBinContent(1,12.78332);
   h_gammaD_1_cT->SetBinContent(2,4.663739);
   h_gammaD_1_cT->SetBinContent(3,1.69332);
   h_gammaD_1_cT->SetBinContent(4,0.6218151);
   h_gammaD_1_cT->SetBinContent(5,0.2378047);
   h_gammaD_1_cT->SetBinContent(6,0.1313588);
   ...
   h_gammaD_2_cT->SetBinContent(1,12.76158);
   h_gammaD_2_cT->SetBinContent(2,4.694856);
   h_gammaD_2_cT->SetBinContent(3,1.697384);
   h_gammaD_2_cT->SetBinContent(4,0.6159497);
   h_gammaD_2_cT->SetBinContent(5,0.2302263);
   h_gammaD_2_cT->SetBinContent(6,0.1288261);
