...
//=========  (Mon Mar 16 13:16:46 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.10625,-1.852413,0.51875,12.39692);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(11.39946);
   ...
   h_gammaD_1_cT->SetBinContent(1,6.350389);
   h_gammaD_1_cT->SetBinContent(2,2.357612);
   h_gammaD_1_cT->SetBinContent(3,0.8599904);
   h_gammaD_1_cT->SetBinContent(4,0.3191302);
   h_gammaD_1_cT->SetBinContent(5,0.1128785);
   h_gammaD_1_cT->SetBinContent(6,0.06707271);
   ...
   h_gammaD_2_cT->SetBinContent(1,6.333035);
   h_gammaD_2_cT->SetBinContent(2,2.371617);
   h_gammaD_2_cT->SetBinContent(3,0.8651172);
   h_gammaD_2_cT->SetBinContent(4,0.3118197);
   h_gammaD_2_cT->SetBinContent(5,0.118411);
   h_gammaD_2_cT->SetBinContent(6,0.06669267);
