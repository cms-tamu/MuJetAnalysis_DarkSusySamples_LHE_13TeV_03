...
//=========  (Mon Mar 16 13:32:41 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-2.125,-0.09347902,10.375,0.6255904);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.5752555);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.3192217);
   h_gammaD_1_cT->SetBinContent(2,0.115573);
   h_gammaD_1_cT->SetBinContent(3,0.04353738);
   h_gammaD_1_cT->SetBinContent(4,0.01552388);
   h_gammaD_1_cT->SetBinContent(5,0.006144084);
   h_gammaD_1_cT->SetBinContent(6,0.003607131);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.3195864);
   h_gammaD_2_cT->SetBinContent(2,0.1166109);
   h_gammaD_2_cT->SetBinContent(3,0.04271977);
   h_gammaD_2_cT->SetBinContent(4,0.01577762);
   h_gammaD_2_cT->SetBinContent(5,0.005305357);
   h_gammaD_2_cT->SetBinContent(6,0.003467677);
