...
//=========  (Wed Mar 18 13:55:36 2015) by ROOT version5.34/18
   ...
   cnv->Range(-106.25,-0.001858948,518.75,0.01244065);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.01143968);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.006339932);
   h_gammaD_1_cT->SetBinContent(2,0.002353674);
   h_gammaD_1_cT->SetBinContent(3,0.000861533);
   h_gammaD_1_cT->SetBinContent(4,0.0003282031);
   h_gammaD_1_cT->SetBinContent(5,0.0001166581);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.006355378);
   h_gammaD_2_cT->SetBinContent(2,0.002346746);
   h_gammaD_2_cT->SetBinContent(3,0.0008627762);
   h_gammaD_2_cT->SetBinContent(4,0.0003173285);
   h_gammaD_2_cT->SetBinContent(5,0.0001177714);
