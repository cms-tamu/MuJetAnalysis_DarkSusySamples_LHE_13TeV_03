...
//=========  (Mon Mar 16 13:28:42 2015) by ROOT version5.34/18
   ...
   cnv->Range(-1.0625,-0.1866498,5.1875,1.249118);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(1.148614);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.6359586);
   h_gammaD_1_cT->SetBinContent(2,0.2352941);
   h_gammaD_1_cT->SetBinContent(3,0.08544137);
   h_gammaD_1_cT->SetBinContent(4,0.03133731);
   h_gammaD_1_cT->SetBinContent(5,0.01196859);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.638119);
   h_gammaD_2_cT->SetBinContent(2,0.2340458);
   h_gammaD_2_cT->SetBinContent(3,0.08477456);
   h_gammaD_2_cT->SetBinContent(4,0.03102736);
   h_gammaD_2_cT->SetBinContent(5,0.01203333);
   h_gammaD_2_cT->SetBinContent(6,0.006960703);
