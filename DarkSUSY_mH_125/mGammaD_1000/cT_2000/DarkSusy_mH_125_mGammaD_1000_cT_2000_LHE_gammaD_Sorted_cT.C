...
//=========  (Wed Mar 18 13:55:18 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-21.25,-0.009267561,103.75,0.06202137);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.05703115);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.03197401);
   h_gammaD_1_cT->SetBinContent(2,0.01164767);
   h_gammaD_1_cT->SetBinContent(3,0.004187425);
   h_gammaD_1_cT->SetBinContent(4,0.001610306);
   h_gammaD_1_cT->SetBinContent(5,0.0005805908);
   h_gammaD_1_cT->SetBinContent(6,0.0003214322);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.03168397);
   h_gammaD_2_cT->SetBinContent(2,0.01182682);
   h_gammaD_2_cT->SetBinContent(3,0.004334529);
   h_gammaD_2_cT->SetBinContent(4,0.001575735);
   h_gammaD_2_cT->SetBinContent(5,0.000578944);
   h_gammaD_2_cT->SetBinContent(6,0.0003423321);
