...
//=========  (Wed Mar 18 13:55:30 2015) by ROOT version5.34/18
   ...
   cnv->Range(-53.125,-0.003721033,259.375,0.0249023);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.02289867);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.0126967);
   h_gammaD_1_cT->SetBinContent(2,0.004717995);
   h_gammaD_1_cT->SetBinContent(3,0.001731425);
   h_gammaD_1_cT->SetBinContent(4,0.0006079372);
   h_gammaD_1_cT->SetBinContent(5,0.0002459439);
   h_gammaD_1_cT->SetBinContent(6,0.0001384536);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.01272148);
   h_gammaD_2_cT->SetBinContent(2,0.004666188);
   h_gammaD_2_cT->SetBinContent(3,0.001720991);
   h_gammaD_2_cT->SetBinContent(4,0.0006569223);
   h_gammaD_2_cT->SetBinContent(5,0.0002344173);
   h_gammaD_2_cT->SetBinContent(6,0.0001430172);
