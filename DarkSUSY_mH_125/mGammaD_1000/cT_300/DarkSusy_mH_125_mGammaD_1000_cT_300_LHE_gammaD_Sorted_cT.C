...
//=========  (Mon Mar 16 13:36:26 2015) by ROOT version5.34/18
   ...
   cnv->Range(-3.1875,-0.06219404,15.5625,0.4162217);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.3827326);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.2120663);
   h_gammaD_1_cT->SetBinContent(2,0.07871535);
   h_gammaD_1_cT->SetBinContent(3,0.02839575);
   h_gammaD_1_cT->SetBinContent(4,0.01043554);
   h_gammaD_1_cT->SetBinContent(5,0.003720388);
   h_gammaD_1_cT->SetBinContent(6,0.002210422);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.2126292);
   h_gammaD_2_cT->SetBinContent(2,0.07809773);
   h_gammaD_2_cT->SetBinContent(3,0.02838468);
   h_gammaD_2_cT->SetBinContent(4,0.0103873);
   h_gammaD_2_cT->SetBinContent(5,0.003834407);
   h_gammaD_2_cT->SetBinContent(6,0.00227799);
