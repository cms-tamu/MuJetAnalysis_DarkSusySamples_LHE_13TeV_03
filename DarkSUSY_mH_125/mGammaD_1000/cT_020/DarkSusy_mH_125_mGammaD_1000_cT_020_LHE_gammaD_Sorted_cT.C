...
//=========  (Mon Mar 16 13:20:52 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.2125,-0.9331626,1.0375,6.245011);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(5.742539);
   ...
   h_gammaD_1_cT->SetBinContent(1,3.175817);
   h_gammaD_1_cT->SetBinContent(2,1.179958);
   h_gammaD_1_cT->SetBinContent(3,0.428246);
   h_gammaD_1_cT->SetBinContent(4,0.1582087);
   h_gammaD_1_cT->SetBinContent(5,0.05777073);
   h_gammaD_1_cT->SetBinContent(6,0.0344233);
   ...
   h_gammaD_2_cT->SetBinContent(1,3.1903);
   h_gammaD_2_cT->SetBinContent(2,1.173125);
   h_gammaD_2_cT->SetBinContent(3,0.4241319);
   h_gammaD_2_cT->SetBinContent(4,0.1550705);
   h_gammaD_2_cT->SetBinContent(5,0.05737292);
   h_gammaD_2_cT->SetBinContent(6,0.03264972);
