...
//=========  (Mon Mar 16 12:54:15 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.53125,-0.3743953,2.59375,2.505568);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(2.303971);
   ...
   h_gammaD_1_cT->SetBinContent(1,1.269437);
   h_gammaD_1_cT->SetBinContent(2,0.4703736);
   h_gammaD_1_cT->SetBinContent(3,0.1731406);
   h_gammaD_1_cT->SetBinContent(4,0.06377009);
   h_gammaD_1_cT->SetBinContent(5,0.02327835);
   h_gammaD_1_cT->SetBinContent(6,0.0132372);
   ...
   h_gammaD_2_cT->SetBinContent(1,1.279984);
   h_gammaD_2_cT->SetBinContent(2,0.4658469);
   h_gammaD_2_cT->SetBinContent(3,0.1678771);
   h_gammaD_2_cT->SetBinContent(4,0.06419051);
   h_gammaD_2_cT->SetBinContent(5,0.02210167);
   h_gammaD_2_cT->SetBinContent(6,0.01379467);
