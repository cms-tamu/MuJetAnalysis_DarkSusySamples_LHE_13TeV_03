...
//=========  (Wed Mar 18 13:54:45 2015) by ROOT version5.34/18
   ...
   cnv->Range(-21.25,-0.009332083,103.75,0.06245317);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.05742821);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.03189404);
   h_gammaD_1_cT->SetBinContent(2,0.01166625);
   h_gammaD_1_cT->SetBinContent(3,0.004349987);
   h_gammaD_1_cT->SetBinContent(4,0.001519633);
   h_gammaD_1_cT->SetBinContent(5,0.0005700982);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.03190456);
   h_gammaD_2_cT->SetBinContent(2,0.0117616);
   h_gammaD_2_cT->SetBinContent(3,0.004235987);
   h_gammaD_2_cT->SetBinContent(4,0.001532179);
   h_gammaD_2_cT->SetBinContent(5,0.0005656792);
