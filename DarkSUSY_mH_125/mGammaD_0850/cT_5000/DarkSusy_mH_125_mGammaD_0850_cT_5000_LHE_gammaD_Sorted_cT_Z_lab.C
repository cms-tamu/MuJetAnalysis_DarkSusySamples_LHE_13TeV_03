...
//=========  (Wed Mar 18 13:53:45 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-53.125,-0.00202559,259.375,0.01355587);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_Z_lab_dummy->SetMaximum(0.01246517);
   ...
   h_gammaD_1_cT_Z_lab->SetBinContent(1,0.005971493);
   h_gammaD_1_cT_Z_lab->SetBinContent(2,0.004535225);
   h_gammaD_1_cT_Z_lab->SetBinContent(3,0.003636364);
   h_gammaD_1_cT_Z_lab->SetBinContent(4,0.003135784);
   h_gammaD_1_cT_Z_lab->SetBinContent(5,0.002721135);
   h_gammaD_1_cT_Z_lab->SetBinContent(6,0.08911683);
   ...
   h_gammaD_2_cT_Z_lab->SetBinContent(1,0.006925094);
   h_gammaD_2_cT_Z_lab->SetBinContent(2,0.004723444);
   h_gammaD_2_cT_Z_lab->SetBinContent(3,0.00340199);
   h_gammaD_2_cT_Z_lab->SetBinContent(4,0.002710021);
   h_gammaD_2_cT_Z_lab->SetBinContent(5,0.002239451);
   h_gammaD_2_cT_Z_lab->SetBinContent(6,0.04171334);
