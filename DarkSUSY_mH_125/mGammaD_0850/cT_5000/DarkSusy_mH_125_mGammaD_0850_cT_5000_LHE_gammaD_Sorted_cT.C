...
//=========  (Wed Mar 18 13:53:28 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-53.125,-0.003722988,259.375,0.02491538);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.0229107);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.01273547);
   h_gammaD_1_cT->SetBinContent(2,0.004662252);
   h_gammaD_1_cT->SetBinContent(3,0.001715804);
   h_gammaD_1_cT->SetBinContent(4,0.0006558574);
   h_gammaD_1_cT->SetBinContent(5,0.0002306201);
   h_gammaD_1_cT->SetBinContent(6,0.0001412422);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.01272816);
   h_gammaD_2_cT->SetBinContent(2,0.004688754);
   h_gammaD_2_cT->SetBinContent(3,0.001700998);
   h_gammaD_2_cT->SetBinContent(4,0.0006467768);
   h_gammaD_2_cT->SetBinContent(5,0.000235306);
   h_gammaD_2_cT->SetBinContent(6,0.0001328787);
