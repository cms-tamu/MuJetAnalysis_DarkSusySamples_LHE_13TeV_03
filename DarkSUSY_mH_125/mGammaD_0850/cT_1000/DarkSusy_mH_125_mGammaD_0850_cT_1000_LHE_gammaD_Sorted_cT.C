...
//=========  (Wed Mar 18 13:54:18 2015) by ROOT version5.34/18
   ...
   cnv->Range(-10.625,-0.0186468,51.875,0.1247901);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.1147495);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.06347011);
   h_gammaD_1_cT->SetBinContent(2,0.02346507);
   h_gammaD_1_cT->SetBinContent(3,0.008722467);
   h_gammaD_1_cT->SetBinContent(4,0.003152926);
   h_gammaD_1_cT->SetBinContent(5,0.001189427);
   h_gammaD_1_cT->SetBinContent(6,0.0006910006);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.06374975);
   h_gammaD_2_cT->SetBinContent(2,0.0231688);
   h_gammaD_2_cT->SetBinContent(3,0.008700413);
   h_gammaD_2_cT->SetBinContent(4,0.00315143);
   h_gammaD_2_cT->SetBinContent(5,0.001229611);
   h_gammaD_2_cT->SetBinContent(6,0.0006833971);
