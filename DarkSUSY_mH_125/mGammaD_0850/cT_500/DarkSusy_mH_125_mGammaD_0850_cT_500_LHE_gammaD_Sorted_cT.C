...
//=========  (Mon Mar 16 13:09:15 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-5.3125,-0.03720063,25.9375,0.248958);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2289269);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.1270119);
   h_gammaD_1_cT->SetBinContent(2,0.04671491);
   h_gammaD_1_cT->SetBinContent(3,0.01759768);
   h_gammaD_1_cT->SetBinContent(4,0.006317247);
   h_gammaD_1_cT->SetBinContent(5,0.002358271);
   h_gammaD_1_cT->SetBinContent(6,0.001343988);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1271816);
   h_gammaD_2_cT->SetBinContent(2,0.04701143);
   h_gammaD_2_cT->SetBinContent(3,0.01714588);
   h_gammaD_2_cT->SetBinContent(4,0.006284304);
   h_gammaD_2_cT->SetBinContent(5,0.002376756);
   h_gammaD_2_cT->SetBinContent(6,0.001417493);
