...
//=========  (Mon Mar 16 13:01:45 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-2.125,-0.09263628,10.375,0.6199505);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.5700695);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.3179501);
   h_gammaD_1_cT->SetBinContent(2,0.1177877);
   h_gammaD_1_cT->SetBinContent(3,0.04262536);
   h_gammaD_1_cT->SetBinContent(4,0.0157902);
   h_gammaD_1_cT->SetBinContent(5,0.005846592);
   h_gammaD_1_cT->SetBinContent(6,0.003467677);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.3167053);
   h_gammaD_2_cT->SetBinContent(2,0.1168411);
   h_gammaD_2_cT->SetBinContent(3,0.0439145);
   h_gammaD_2_cT->SetBinContent(4,0.01629888);
   h_gammaD_2_cT->SetBinContent(5,0.00624025);
   h_gammaD_2_cT->SetBinContent(6,0.003239646);
