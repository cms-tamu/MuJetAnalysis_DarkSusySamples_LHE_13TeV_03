...
//=========  (Mon Mar 16 12:58:01 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-1.0625,-0.1860507,5.1875,1.245108);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(1.144927);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.634301);
   h_gammaD_1_cT->SetBinContent(2,0.2346634);
   h_gammaD_1_cT->SetBinContent(3,0.08667749);
   h_gammaD_1_cT->SetBinContent(4,0.03290674);
   h_gammaD_1_cT->SetBinContent(5,0.01145129);
   h_gammaD_1_cT->SetBinContent(6,0.006694603);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.6360707);
   h_gammaD_2_cT->SetBinContent(2,0.2354037);
   h_gammaD_2_cT->SetBinContent(3,0.08628783);
   h_gammaD_2_cT->SetBinContent(4,0.03065886);
   h_gammaD_2_cT->SetBinContent(5,0.01157888);
   h_gammaD_2_cT->SetBinContent(6,0.006846643);
