...
//=========  (Mon Mar 16 12:46:58 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.10625,-1.867908,0.51875,12.50062);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(11.49482);
   ...
   h_gammaD_1_cT->SetBinContent(1,6.339072);
   h_gammaD_1_cT->SetBinContent(2,2.369302);
   h_gammaD_1_cT->SetBinContent(3,0.8685092);
   h_gammaD_1_cT->SetBinContent(4,0.3033049);
   h_gammaD_1_cT->SetBinContent(5,0.1198117);
   h_gammaD_1_cT->SetBinContent(6,0.06808628);
   ...
   h_gammaD_2_cT->SetBinContent(1,6.386011);
   h_gammaD_2_cT->SetBinContent(2,2.32586);
   h_gammaD_2_cT->SetBinContent(3,0.8633691);
   h_gammaD_2_cT->SetBinContent(4,0.3133458);
   h_gammaD_2_cT->SetBinContent(5,0.1114146);
   h_gammaD_2_cT->SetBinContent(6,0.07125502);
