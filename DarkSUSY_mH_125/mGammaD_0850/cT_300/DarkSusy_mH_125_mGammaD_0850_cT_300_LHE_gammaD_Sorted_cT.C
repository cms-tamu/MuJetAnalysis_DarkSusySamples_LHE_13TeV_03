...
//=========  (Mon Mar 16 13:05:30 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-3.1875,-0.06195241,15.5625,0.4146046);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.3812456);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.2119973);
   h_gammaD_1_cT->SetBinContent(2,0.07787202);
   h_gammaD_1_cT->SetBinContent(3,0.02881663);
   h_gammaD_1_cT->SetBinContent(4,0.01075066);
   h_gammaD_1_cT->SetBinContent(5,0.003896747);
   h_gammaD_1_cT->SetBinContent(6,0.002227312);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.2118031);
   h_gammaD_2_cT->SetBinContent(2,0.07789162);
   h_gammaD_2_cT->SetBinContent(3,0.02900849);
   h_gammaD_2_cT->SetBinContent(4,0.01069882);
   h_gammaD_2_cT->SetBinContent(5,0.003931293);
   h_gammaD_2_cT->SetBinContent(6,0.002311785);
