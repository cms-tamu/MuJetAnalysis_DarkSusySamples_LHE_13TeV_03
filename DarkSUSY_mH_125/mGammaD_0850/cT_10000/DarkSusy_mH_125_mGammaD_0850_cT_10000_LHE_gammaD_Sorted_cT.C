...
//=========  (Wed Mar 18 13:53:52 2015) by ROOT version5.34/18
   ...
   cnv->Range(-106.25,-0.001861845,518.75,0.01246004);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.01145751);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.006366636);
   h_gammaD_1_cT->SetBinContent(2,0.00233971);
   h_gammaD_1_cT->SetBinContent(3,0.0008568946);
   h_gammaD_1_cT->SetBinContent(4,0.0003196353);
   h_gammaD_1_cT->SetBinContent(5,0.000117124);
   h_gammaD_1_cT->SetBinContent(6,7.506014e-05);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.006365283);
   h_gammaD_2_cT->SetBinContent(2,0.002343038);
   h_gammaD_2_cT->SetBinContent(3,0.0008685422);
   h_gammaD_2_cT->SetBinContent(4,0.0003105262);
   h_gammaD_2_cT->SetBinContent(5,0.0001126098);
