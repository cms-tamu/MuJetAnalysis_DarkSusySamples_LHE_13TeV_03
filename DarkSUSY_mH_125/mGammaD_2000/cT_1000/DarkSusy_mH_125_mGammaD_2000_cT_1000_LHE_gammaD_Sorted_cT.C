...
//=========  (Wed Mar 18 13:57:11 2015) by ROOT version5.34/18
   ...
   cnv->Range(-10.625,-0.01861926,51.875,0.1246058);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.1145801);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.06343441);
   h_gammaD_1_cT->SetBinContent(2,0.02358117);
   h_gammaD_1_cT->SetBinContent(3,0.008736422);
   h_gammaD_1_cT->SetBinContent(4,0.003090033);
   h_gammaD_1_cT->SetBinContent(5,0.001157976);
   h_gammaD_1_cT->SetBinContent(6,0.000692268);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.06365559);
   h_gammaD_2_cT->SetBinContent(2,0.02336858);
   h_gammaD_2_cT->SetBinContent(3,0.008616566);
   h_gammaD_2_cT->SetBinContent(4,0.003147029);
   h_gammaD_2_cT->SetBinContent(5,0.001212236);
   h_gammaD_2_cT->SetBinContent(6,0.0007036757);
