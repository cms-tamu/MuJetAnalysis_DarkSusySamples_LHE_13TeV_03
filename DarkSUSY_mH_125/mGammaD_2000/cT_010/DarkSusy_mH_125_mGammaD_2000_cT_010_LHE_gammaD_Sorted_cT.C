...
//=========  (Mon Mar 16 14:30:41 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.10625,-1.868559,0.51875,12.50497);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(11.49882);
   ...
   h_gammaD_1_cT->SetBinContent(1,6.377149);
   h_gammaD_1_cT->SetBinContent(2,2.331412);
   h_gammaD_1_cT->SetBinContent(3,0.8549601);
   h_gammaD_1_cT->SetBinContent(4,0.3218214);
   h_gammaD_1_cT->SetBinContent(5,0.1146575);
   h_gammaD_1_cT->SetBinContent(6,0.06859315);
   ...
   h_gammaD_2_cT->SetBinContent(1,6.388235);
   h_gammaD_2_cT->SetBinContent(2,2.341266);
   h_gammaD_2_cT->SetBinContent(3,0.8412097);
   h_gammaD_2_cT->SetBinContent(4,0.3068326);
   h_gammaD_2_cT->SetBinContent(5,0.1224562);
   h_gammaD_2_cT->SetBinContent(6,0.06821299);
