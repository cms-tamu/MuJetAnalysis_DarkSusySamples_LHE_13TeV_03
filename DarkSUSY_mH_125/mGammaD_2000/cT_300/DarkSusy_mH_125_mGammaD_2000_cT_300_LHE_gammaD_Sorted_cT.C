...
//=========  (Mon Mar 16 15:01:45 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-3.1875,-0.06209454,15.5625,0.4155558);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.3821202);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.2118046);
   h_gammaD_1_cT->SetBinContent(2,0.07807766);
   h_gammaD_1_cT->SetBinContent(3,0.02882332);
   h_gammaD_1_cT->SetBinContent(4,0.01062464);
   h_gammaD_1_cT->SetBinContent(5,0.004003122);
   h_gammaD_1_cT->SetBinContent(6,0.002354037);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.212289);
   h_gammaD_2_cT->SetBinContent(2,0.0780797);
   h_gammaD_2_cT->SetBinContent(3,0.02840673);
   h_gammaD_2_cT->SetBinContent(4,0.01079464);
   h_gammaD_2_cT->SetBinContent(5,0.003763231);
   h_gammaD_2_cT->SetBinContent(6,0.002290662);
