...
//=========  (Wed Mar 18 13:58:11 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-21.25,-0.009314112,103.75,0.0623329);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.05731761);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.03196384);
   h_gammaD_1_cT->SetBinContent(2,0.01156369);
   h_gammaD_1_cT->SetBinContent(3,0.00428602);
   h_gammaD_1_cT->SetBinContent(4,0.001574521);
   h_gammaD_1_cT->SetBinContent(5,0.0006119288);
   h_gammaD_1_cT->SetBinContent(6,0.0003638836);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.03184312);
   h_gammaD_2_cT->SetBinContent(2,0.01164972);
   h_gammaD_2_cT->SetBinContent(3,0.004318393);
   h_gammaD_2_cT->SetBinContent(4,0.001607444);
   h_gammaD_2_cT->SetBinContent(5,0.0005813222);
   h_gammaD_2_cT->SetBinContent(6,0.0003302967);
