...
//=========  (Mon Mar 16 14:26:27 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.053125,-3.724749,0.259375,24.92717);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(22.92153);
   ...
   h_gammaD_1_cT->SetBinContent(1,12.71471);
   h_gammaD_1_cT->SetBinContent(2,4.699414);
   h_gammaD_1_cT->SetBinContent(3,1.756461);
   h_gammaD_1_cT->SetBinContent(4,0.6072121);
   h_gammaD_1_cT->SetBinContent(5,0.2221999);
   h_gammaD_1_cT->SetBinContent(6,0.1311055);
   ...
   h_gammaD_2_cT->SetBinContent(1,12.73418);
   h_gammaD_2_cT->SetBinContent(2,4.666062);
   h_gammaD_2_cT->SetBinContent(3,1.716386);
   h_gammaD_2_cT->SetBinContent(4,0.6484908);
   h_gammaD_2_cT->SetBinContent(5,0.2348765);
   h_gammaD_2_cT->SetBinContent(6,0.1392141);
