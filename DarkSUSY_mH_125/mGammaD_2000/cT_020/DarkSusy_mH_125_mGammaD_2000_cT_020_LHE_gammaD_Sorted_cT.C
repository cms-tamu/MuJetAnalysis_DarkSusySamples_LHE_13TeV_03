...
//=========  (Mon Mar 16 15:01:12 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.2125,-0.9354426,1.0375,6.26027);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(5.75657);
   ...
   h_gammaD_1_cT->SetBinContent(1,3.184691);
   h_gammaD_1_cT->SetBinContent(2,1.174152);
   h_gammaD_1_cT->SetBinContent(3,0.4286128);
   h_gammaD_1_cT->SetBinContent(4,0.1531749);
   h_gammaD_1_cT->SetBinContent(5,0.05936867);
   h_gammaD_1_cT->SetBinContent(6,0.03651519);
   ...
   h_gammaD_2_cT->SetBinContent(1,3.198094);
   h_gammaD_2_cT->SetBinContent(2,1.166616);
   h_gammaD_2_cT->SetBinContent(3,0.4234003);
   h_gammaD_2_cT->SetBinContent(4,0.157076);
   h_gammaD_2_cT->SetBinContent(5,0.05481297);
   h_gammaD_2_cT->SetBinContent(6,0.0344233);
