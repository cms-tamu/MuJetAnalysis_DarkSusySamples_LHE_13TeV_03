...
//=========  (Mon Mar 16 14:59:59 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-2.125,-0.0926115,10.375,0.6197847);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.569917);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.3189811);
   h_gammaD_1_cT->SetBinContent(2,0.1157826);
   h_gammaD_1_cT->SetBinContent(3,0.04298734);
   h_gammaD_1_cT->SetBinContent(4,0.01607462);
   h_gammaD_1_cT->SetBinContent(5,0.006174316);
   h_gammaD_1_cT->SetBinContent(6,0.003505702);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.3166205);
   h_gammaD_2_cT->SetBinContent(2,0.1175642);
   h_gammaD_2_cT->SetBinContent(3,0.04416835);
   h_gammaD_2_cT->SetBinContent(4,0.01561399);
   h_gammaD_2_cT->SetBinContent(5,0.006032964);
   h_gammaD_2_cT->SetBinContent(6,0.003264972);
