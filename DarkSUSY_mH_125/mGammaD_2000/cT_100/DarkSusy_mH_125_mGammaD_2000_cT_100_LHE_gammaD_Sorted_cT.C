...
//=========  (Mon Mar 16 15:09:20 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-1.0625,-0.1857021,5.1875,1.242776);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(1.142782);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.6360389);
   h_gammaD_1_cT->SetBinContent(2,0.2335132);
   h_gammaD_1_cT->SetBinContent(3,0.08632378);
   h_gammaD_1_cT->SetBinContent(4,0.03206168);
   h_gammaD_1_cT->SetBinContent(5,0.01206244);
   h_gammaD_1_cT->SetBinContent(6,0.006238758);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.6348791);
   h_gammaD_2_cT->SetBinContent(2,0.2366317);
   h_gammaD_2_cT->SetBinContent(3,0.08561752);
   h_gammaD_2_cT->SetBinContent(4,0.03039422);
   h_gammaD_2_cT->SetBinContent(5,0.01247749);
   h_gammaD_2_cT->SetBinContent(6,0.007252307);
