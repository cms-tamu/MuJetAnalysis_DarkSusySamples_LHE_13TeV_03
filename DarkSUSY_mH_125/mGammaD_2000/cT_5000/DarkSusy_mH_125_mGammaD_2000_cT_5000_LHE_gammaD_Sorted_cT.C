...
//=========  (Wed Mar 18 13:57:33 2015) by ROOT version5.34/18
   ...
   cnv->Range(-53.125,-0.003715321,259.375,0.02486407);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.02286351);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.01275948);
   h_gammaD_1_cT->SetBinContent(2,0.004669998);
   h_gammaD_1_cT->SetBinContent(3,0.001696144);
   h_gammaD_1_cT->SetBinContent(4,0.0006364632);
   h_gammaD_1_cT->SetBinContent(5,0.0002379184);
   h_gammaD_1_cT->SetBinContent(6,0.0001409887);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.01270195);
   h_gammaD_2_cT->SetBinContent(2,0.004650572);
   h_gammaD_2_cT->SetBinContent(3,0.001788972);
   h_gammaD_2_cT->SetBinContent(4,0.0006219885);
   h_gammaD_2_cT->SetBinContent(5,0.0002365167);
   h_gammaD_2_cT->SetBinContent(6,0.0001288261);
