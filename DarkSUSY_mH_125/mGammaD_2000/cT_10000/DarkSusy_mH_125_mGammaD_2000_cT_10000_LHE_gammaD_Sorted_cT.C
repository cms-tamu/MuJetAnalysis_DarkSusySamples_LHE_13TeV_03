...
//=========  (Wed Mar 18 13:57:00 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-106.25,-0.001861665,518.75,0.01245883);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.0114564);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.006374418);
   h_gammaD_1_cT->SetBinContent(2,0.00232084);
   h_gammaD_1_cT->SetBinContent(3,0.0008743554);
   h_gammaD_1_cT->SetBinContent(4,0.0003160609);
   h_gammaD_1_cT->SetBinContent(5,0.0001143252);
   h_gammaD_1_cT->SetBinContent(6,6.15017e-05);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.006364666);
   h_gammaD_2_cT->SetBinContent(2,0.002333459);
   h_gammaD_2_cT->SetBinContent(3,0.0008785705);
   h_gammaD_2_cT->SetBinContent(4,0.0003062791);
   h_gammaD_2_cT->SetBinContent(5,0.0001170253);
   h_gammaD_2_cT->SetBinContent(6,6.6566e-05);
