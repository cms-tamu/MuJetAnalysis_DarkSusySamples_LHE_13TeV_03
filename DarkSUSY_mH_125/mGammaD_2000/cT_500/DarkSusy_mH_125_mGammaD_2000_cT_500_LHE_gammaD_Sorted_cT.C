...
//=========  (Mon Mar 16 14:59:23 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-5.3125,-0.03739508,25.9375,0.2502594);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2301236);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.1269847);
   h_gammaD_1_cT->SetBinContent(2,0.04731789);
   h_gammaD_1_cT->SetBinContent(3,0.01718866);
   h_gammaD_1_cT->SetBinContent(4,0.006153188);
   h_gammaD_1_cT->SetBinContent(5,0.002355576);
   h_gammaD_1_cT->SetBinContent(6,0.001328787);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1278464);
   h_gammaD_2_cT->SetBinContent(2,0.04635116);
   h_gammaD_2_cT->SetBinContent(3,0.01711517);
   h_gammaD_2_cT->SetBinContent(4,0.006464443);
   h_gammaD_2_cT->SetBinContent(5,0.002222782);
